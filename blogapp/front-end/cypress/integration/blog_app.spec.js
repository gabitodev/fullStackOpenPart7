  ...
  describe("when logged in", function () {
    ...
    it("a blog can be created", function () {
      ...
      cy.get(".success")
        .should(
          "contain",
          "A new blog React Patterns by Ronald McGregor was added"
        )
    ...
    describe("and several blogs exist", function () {
      beforeEach(function () {
        cy.createBlog({
          title: "Learning with FullStack2022",
          author: "Professor Junior",
          url: "www.fullstackopen2022.com",
        });
        cy.createBlog({
          title: "The mind behind JavaScript",
          author: "Javascript Creator",
      ...
      it("a blog can be liked", function () {
        cy.get(".blog")
          .contains("Learning with FullStack2022 by Professor Junior")
          .contains("View")
          .click();
      ...
      it("blogs list are ordered by most likes", function () {
        cy.get(".blog")
          .contains("Test Blog 3 by Cypress")
          .contains("View")
          .click();
        cy.get(".blog").contains("Like").click();
        cy.get(".blog").contains("Likes 1");
        ...
        cy.get(".blog")
          ...
          .click();
        cy.get(".blog")
          .contains("The mind behind JavaScript by Javascript Creator")
          .contains("View")
          .click();
        cy.get(".blog").contains("Like").click();
        cy.get(".blog").contains("Likes 1");
        ...
        cy.get(".blog")
          ...
          .should(
            "contain",
            "The mind behind JavaScript by Javascript Creator"
          );
      });
      ...
      it("a blog can be removed by the user who created", function () {
        ...
        cy.get(".blog").should(
          "not.contain",
          "Learning with FullStack2022 by Professor Junior"
        );
      });
    });
  });
